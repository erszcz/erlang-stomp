...
yeccpars2_3(S, comparator, Ss, Stack, T, Ts, Tzr) ->
...
yeccgoto_predicate(19=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_22(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_predicate(20=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_21(_S, Cat, Ss, Stack, T, Ts, Tzr);
...
-file("src/sql_parser.yrl", 13).
yeccpars2_6_(__Stack0) ->
 [__3,__2,__1 | __Stack] = __Stack0,
 [begin
   { predicate , { var , unwrap ( __1 ) } , memberof , __3 }
  end | __Stack].

-compile({inline,yeccpars2_9_/1}).
-file("src/sql_parser.yrl", 21).
